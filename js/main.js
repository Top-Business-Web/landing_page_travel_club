!(function (e) {
  ...
  jQuery(".mean-menu").meanmenu({
    ...
    e('a[href="#header-search"]').on("click", function (s) {
      s.preventDefault(),
        e("#header-search").addClass("open"),
        e('#header-search > form > input[type="search"]').focus();
    }),
    ...
    e(".home-slides").on("translate.owl.carousel", function () {
      e(".main-banner h1")
        ...
        e(".main-banner p")
          ...
          .css("opacity", "0"),
        e(".main-banner .btn, .main-banner .video-btn")
          .removeClass("animate__animated animate__fadeInDown")
          .css("opacity", "0"),
        e(".main-banner .startup-image")
          .removeClass("animate__animated animate__zoomIn")
          .css("opacity", "0");
    }),
    ...
    e(window).on("scroll", function () {
      e(this).scrollTop() > 120
        ? e(".crake-nav").addClass("is-sticky")
        : e(".crake-nav").removeClass("is-sticky");
    }),
      ...
      e(".accordion")
        ...
        .on("click", function () {
          e(this).toggleClass("active"),
            ...
            e(".accordion-content").not(e(this).next()).slideUp("fast"),
            e(".accordion-title").not(e(this)).removeClass("active");
        });
    }),
    setInterval(function () {
      var s, a, t, o, i, n, l;
      (s = new Date("April 26, 2025 17:00:00 PDT")),
        (s = Date.parse(s) / 1e3),
        (a = new Date()),
        (t = s - (a = Date.parse(a) / 1e3)),
        (o = Math.floor(t / 86400)),
        (i = Math.floor((t - 86400 * o) / 3600)),
        (n = Math.floor((t - 86400 * o - 3600 * i) / 60)),
        (l = Math.floor(t - 86400 * o - 3600 * i - 60 * n)),
        i < "10" && (i = "0" + i),
        n < "10" && (n = "0" + n),
        l < "10" && (l = "0" + l),
        e("#days").html(o + "<span>Days</span>"),
